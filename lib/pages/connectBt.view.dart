    ...
    bluetooth.onStateChanged().listen((state) {
      switch (state) {
        case BlueThermalPrinter.CONNECTED:
          setState(() {
            _connected = true;
            Get.snackbar("Statut","Connecté", backgroundColor: Colors.green, colorText: Colors.white);
        ...
        case BlueThermalPrinter.DISCONNECTED:
          setState(() {
            _connected = false;
            Get.snackbar("Statut","Déconnecté", backgroundColor: Colors.green, colorText: Colors.white);
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Connectez l\'imprimente'),
        ),
        body: Padding(
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                      _connected ? 'Deconnecter' : 'Connecter',
                      style: TextStyle(color: Colors.white),
                    ),
                  ),
                ],
