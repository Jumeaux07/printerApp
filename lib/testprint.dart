...
import 'package:printer_app2/printerenum.dart';
  ...
  sample() async {
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected == true) {
        ...
        bluetooth.printCustom("BIENVENUE", Size.boldMedium.val, Align.center.val);
        // bluetooth.printNewLine();
        ...
        bluetooth.printNewLine();
        bluetooth.printNewLine();
        bluetooth.printLeftRight("Numéro d'attente", "${_controller.number}", Size.bold.val,charset: "windows-1250");
        bluetooth.printLeftRight("Date", "${_controller.listAttente.last.date}", Size.bold.val,charset: "windows-1250");
        bluetooth.printNewLine();
        bluetooth.printNewLine();
        bluetooth.printCustom("Nous vous prions de patienter", Size.boldMedium.val, Align.center.val);
        bluetooth.printCustom("Merci pour votre comprehension", Size.boldMedium.val, Align.center.val);
